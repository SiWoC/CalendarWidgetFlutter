...
abstract class AppLocalizations {
  ...
  /// No description provided for @settingsHeaderColor.
  ///
  /// In en, this message translates to:
  /// **'Header color'**
  String get settingsHeaderColor;

  /// No description provided for @settingsHeaderFontSize.
  ///
  /// In en, this message translates to:
  /// **'Header font size'**
  String get settingsHeaderFontSize;

  /// No description provided for @settingsEventFontSize.
  ///
  /// In en, this message translates to:
  /// **'Event font size'**
  String get settingsEventFontSize;

  /// No description provided for @settingsFetchDays.
  ///
  /// In en, this message translates to:
  /// **'Days to fetch'**
  String get settingsFetchDays;
  ...
  /// No description provided for @settingsFetchDaysValue.
  ///
  /// In en, this message translates to:
  /// **'{days} days'**
  ...
  /// No description provided for @settingsOpacityValue.
  ///
  /// In en, this message translates to:
  /// **'{percent}%'**
